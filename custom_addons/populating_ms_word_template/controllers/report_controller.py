...
class ReportControllerInherit(ReportController):
    ...
    def report_routes(self, reportname, docids=None, converter=None, **data):
        ...
        if converter == "pdf" and report.populating_ms_word_template:
            ...
            if data.get("context"):
                ...
                # webclient *but* if the user explicitely wants to change the lang,
            ...
            return super(ReportControllerInherit, self).report_routes(
    ...
    def report_download(self, data, context=None):
        ...
        report = request.env["ir.actions.report"]._get_report_from_name(reportname)
        try:
            if type in ["qweb-pdf", "qweb-text"] and report.populating_ms_word_template:
                ...
                if not report.populating_ms_word_template:
                    return super(ReportControllerInherit, self).report_download(
                        data, context
                    )
                if report.type_export == "pdf":
                    extension = "pdf"
